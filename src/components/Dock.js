        ...
        >
                ...
                {(isWindowOpen("files") || isWindowMinimized("files")) && (
                    <div
                        style={{
                            width: "8px",
                            height: "8px",
                            backgroundColor: isWindowMinimized("files")
                                ? "#6c7086"
                                : "#f5c2e7", // overlay 0 : pink
                            borderRadius: "50%",
                            marginTop: "5px",
                            marginLeft: "15px",
                        }}
            ...
            >
                ...
                {(isWindowOpen("terminal") ||
                    isWindowMinimized("terminal")) && (
                    <div
                        style={{
                            width: "8px",
                            height: "8px",
                            backgroundColor: isWindowMinimized("terminal")
                                ? "#6c7086"
                                : "#f5c2e7",
                            borderRadius: "50%",
                            marginTop: "5px",
            ...
            >
                ...
                {(isWindowOpen("settings") ||
                    isWindowMinimized("settings")) && (
                    <div
                        style={{
                            width: "8px",
                            height: "8px",
                            backgroundColor: isWindowMinimized("settings")
                                ? "#6c7086"
                                : "#f5c2e7",
                            borderRadius: "50%",
                            marginTop: "5px",
